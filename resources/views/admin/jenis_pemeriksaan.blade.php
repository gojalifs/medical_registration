...
@section('dash-content')
    <div>
        <div class="flex justify-between">
            ...
            <button data-modal-target="crud-modal" data-modal-toggle="crud-modal" class="flex bg-green-400 hover:bg-teal-300 px-3 py-1">
                ...
                <form class="p-4 md:p-5">
                    <div class="grid gap-4 mb-4 grid-cols-2">
                        <div class="col-span-2">
                            <label for="name"
                                class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Nama Pemeriksaan</label>
